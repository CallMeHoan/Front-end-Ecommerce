$(document).ready(function() {
    ...
    <div class="p-5 pt-5">
      ...
      <div class="mb-5">
        <h5 style="text-transform: uppercase;">Best sellers</h5>
        <div class="best_seller_item">
          <a href="#">
            <div class="bs_item_top">
              <div class="bs_img">
                <img src="https://opencart.mahardhi.com/MT04/noriva/01/image/cache/catalog/products/1-80x80.jpg">
              </div>
              <div class="bs_rating_price">
                <h5>$96.69</h5>
                <div class="rating">
